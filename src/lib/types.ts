...
export type SellerSettings = {
  ...
  orgForm?: OrgForm;
  /**
   * Ставка упрощёнки в % с учётом решения маслихата региона (ст. 726 НК РК:
   * базовая 4%, маслихат может ±50% → 2-6%). Если не задана — берётся 4%.
   * На 2026: Алматы/Астана 3%, Шымкент 2%, большинство районов 2-3%.
   */
